...
```{r data-cleaning, include=FALSE}
  ...
  #arrow in the r source and set a benchmark to remove all greater than 3 hrs that is 10800 seconds
...
* Removing trips longer than 3 hours (10,800 seconds), as they likely represent data errors or bike maintenance trips, not typical rider behavior.

Only 1.238% of the total data was removed, ensuring minimal data loss while improving data quality. I now rearranged my dataset so that related fields are positioned close together for better readability and logical flow. Below is a sample of the cleaned dataset:
...
To better understand how casual riders and members use bikes across the week, I calculated the average count of trips taken by each user type on weekdays vs weekends: 

```{r avg_daytype_trip_count, echo=FALSE}
avg_day_type_trip_count <- merged_divvy_data8 %>%
  group_by(usertype, day_type) %>%
