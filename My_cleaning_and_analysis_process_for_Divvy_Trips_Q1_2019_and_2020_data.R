  ...
  #arrow in the r source(that place that shows the datasets) and so I set a benchmark to remove all hours greater than 3 hrs that is 10800seconds
  ...
  #The avg_trip duration for casual users was 31 minutes and from member was 11 minutes
 ...
 #Casual riders use bikes mostly on weekends with the amount of times bikes 
  #where ordered on saturday and sunday as 15507 and 8582 times. There was a huge drop on weekdays 
  ...
  #members similarly to cusal rideers ride least at night from 12am - 4am with a slighly higher amunt from 
